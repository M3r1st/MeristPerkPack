class X2Effect_SpectralUnit extends X2Effect_Persistent;

var name AddEffectAnimName;
var name RemoveEffectAnimName;
...
simulated function AddX2ActionsForVisualization_Removed(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, const name EffectApplyResult, XComGameState_Effect RemovedEffect)
{
    ...
    AnimationAction.Params.AnimName = RemoveEffectAnimName;
...
simulated function AddX2ActionsForVisualization_Sync( XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata )
{
    ...
    AnimationAction.Params.AnimName = AddEffectAnimName;
    AnimationAction.Params.BlendTime = 0.0f;
    AnimationAction.Params.Additive = true;
