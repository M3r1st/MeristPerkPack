//---------------------------------------------------------------------------------------
//  FILE:    X2Effect_AddAbility.uc
//  AUTHOR:  Merist / based on X2Effect_WOTC_APA_Class_AddAbilitiesToTarget
//---------------------------------------------------------------------------------------

class X2Effect_AddAbilities extends X2Effect_Persistent;

var array<name> AddAbilities;
var eInventorySlot ApplyToWeaponSlot;
var name ApplyToWeaponCat;
var name ApplyToItem;
