...
final function UIScrollingTextField InitScrollingText(optional name InitName, optional string initText, optional float initWidth,
...
final function UIScrollingTextField SetText(optional string txt)
{
    if(text != txt)
    {
        text = txt;
...
final function UIScrollingTextField SetTitle(optional string txt, optional bool bReversed, optional bool bForce)
{
...
final function UIScrollingTextField SetSubTitle(optional string txt, optional bool bReversed, optional bool bForce)
{
    local string formattedText;
    if(text != txt || bForce)
    {
...
final function UIScrollingTextField SetHTMLText(optional string txt, optional bool bForce = false)
{
...
final function UIScrollingTextField ResetScroll()
{
    mc.FunctionVoid("resetScroll");
    return self;
}

final function UIScrollingTextField SetDisabled(optional bool bDisable = true)
{
...
final function ShowShadow(	optional int ShadowColor = DefaultShadowColor, 
