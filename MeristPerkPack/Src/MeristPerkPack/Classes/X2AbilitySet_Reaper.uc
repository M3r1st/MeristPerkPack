...
static function array<X2DataTemplate> CreateTemplates()
{
    ...
    Templates.AddItem(TricksOfTheTrade());
...
static function X2AbilityTemplate Aim()
{
    ...
    Template = Passive('M31_RE_Aim', "img:///UILibrary_XPACK_Common.PerkIcons.UIPerk_vektorrifle", false, true);
...
static function X2AbilityTemplate TricksOfTheTrade()
{
    local X2AbilityTemplate     Template;

    Template = Passive('M31_RE_Tricks', "", false, true);
