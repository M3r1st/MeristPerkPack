...
//---------------------------------------------------------------------------------------
class X2Effect_SuperheavyOrdnanceRange extends X2Effect_Persistent;
	...
	Object CallbackData)
{
	...
	{
		OverrideTuple.Data[1].i = `GetConfigInt("M31_SuperheavyOrdnance_RangeBonus");
	}
...
defaultproperties
{
	...
	EffectName = "M31_SuperheavyOrdnance_RangeBonus"
